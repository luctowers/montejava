...
public class LocalTest {
	...
	public static void main(String[] args) {
		...
		Player white = new MonteCarloPlayer(new LegalMoveGenerator(), () -> new FastRandomPlayer(4),  4, 10000, 0.3);
		Player black = new MonteCarloPlayer(new LegalMoveGenerator(), () -> new UniformRandomPlayer(new LegalMoveGenerator()),  4, 10000, 0.3);
